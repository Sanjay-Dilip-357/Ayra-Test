...
function showPreview() {
    ...
    // ✅ FIX: Explicitly get phone from the ACTIVE template's phone input
    var activePhoneInput = document.getElementById(p + '_phone_update');
    if (activePhoneInput) {
        fd.set('phone_update', activePhoneInput.value.trim());
    }
